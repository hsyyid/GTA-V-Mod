...
import com.arisux.airix.client.render.Color;
...
public class XRDR
{
	public static XRDR instance = new XRDR();
    public ArrayList<Framebuffer> frameBuffers = new ArrayList<Framebuffer>();
    ...
    {
        return AIRIX.game().getTextureManager();
    }
    ...
    public void copyDownsizedRender(TextureManager manager, ResourceLocation renderTo, int x, int y, int w, int h, int index)
    {
    ...
    public Framebuffer bufferAdd(int width, int height, boolean useDepth)
    {
    ...
    public void bufferClear(Framebuffer buffer)
    {
     ...
     */
    public int getTexID(ResourceLocation resource)
    {
        Object object = AIRIX.game().getTextureManager().getTexture(resource);
     ...
     */
    public void colorHex4(int color)
    {
     ...
     */
    public void colorHex3(int color)
    {
        float r = (color >> 16 & 255) / 255.0F;
        float g = (color >> 8 & 255) / 255.0F;
        float b = (color & 255) / 255.0F;
     ...
     */
    public int createHexColor(int a, int r, int g, int b)
    {
    ...
    public void bindResource(ResourceLocation resource)
    {
    ...
    public void drawQuadColored(int x, int y, int w, int h, int color)
    {
    ...
    public void drawQuadRelative(int x, int y, int w, int h)
    {
        drawQuadRelative(x, y, x + w, y + h, 0);
    }

    public void drawQuadRelative(int x, int y, int w, int h, int z)
    {
        drawQuad(x, y, x + w, y + h, z, 0, 1, 0, 1);
    }

    public void drawQuad(int x1, int y1, int x2, int y2)
    {
        drawQuad(x1, y1, x2, y2, 0);
    }

    public void drawQuad(int x1, int y1, int x2, int y2, int z)
    {
        drawQuad(x1, y1, x2, y2, z, 0, 1, 0, 1);
    }

    public void drawQuad(int x1, int y1, int x2, int y2, int z, float minU, float maxU, float minV, float maxV)
    {
	...
	{
		AIRIX.game().renderEngine.bindTexture(resource);
	}
}
